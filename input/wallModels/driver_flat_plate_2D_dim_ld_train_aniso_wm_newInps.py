...
from PyFlowCL import PyFlowCL_aniso, Grid, Data, Model
...
class inputConfigClass:
    def __init__(self,Nx1,Nx2,dt,Nsteps,resume):
        ...
        self.U0    = 3513.75    # m/s
        self.T0    = 300                   # K
        self.rho0  = 8.31e-06 # kg/m^3 # Kn-0.6
        ...
        # self.outDir = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M10_dist_wall_scalar_trans_model_aPost_BCFix_aniso_infer'.format(self.Nx1,self.Nx2)
        self.outDir = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M7_aniso_distWall_distKn'.format(self.Nx1,self.Nx2)
        ...
        if resume:
            ...
            self.dfName_read  =   '/home/anair/Repos/pyflowCL_lineRelax/pyflowcl/verification/flat_plate_2D/M7Tests_lowDense/Output_flat_plate_2D_Nx1_256_Nx2_256_M7_converge_lowDense/PyFlowCL_000138000.h5'
            self.dfName_read_1  = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M7_rhoFac1by2_noModel/PyFlowCL_000414000.h5'
            self.dfName_read_2  = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M7_rhoFac1by4_noModel/PyFlowCL_007676000.h5'
            #self.dfName_read = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M10_dist_wall_scalar_trans_model_aPost_BCFix_aniso_infer/PyFlowCL_000479000.h5'
            #self.dfName_read = '/data/Home_backup/flat_plate_2D/outOfSample_lowDense/aniso/Output_flat_plate_2D_Nx1_256_Nx2_256_M3_infer/PyFlowCL_000049000.h5'
            #self.dfName_read = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M7_rhoFac1by4_noModel/PyFlowCL_007676000.h5'.format(self.Nx1,self.Nx2)
        else:
        ...
        self.modelName_read = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M7_dist_wall_scalar_trans_model_aPost_BCFix_aniso' + '/saveMod_13'
        self.optimizerName_read = '/data/PyFlow/viscModels/Scalar/Output_flat_plate_2D_Nx1_256_Nx2_256_M7_dist_wall_scalar_trans_model_aPost_BCFix_aniso' + '/saveOpt_13' #   'saveOpt'
    ...
    def load_target_data(self, EOS, names, decomp, cfg, grid, param, comms):
        ...
        if decomp.rank == 0:
            ...
            DSMCfilePath = '/data/PyFlow/newDSMC_knudsen/filtered/M7_256_256_fac1by2_filt_refined.npy'
            
        else:
            DSMCfilePath = '/data/PyFlow/newDSMC_knudsen/filtered/M7_256_256_fac1by4_filt_refined.npy'
    ...
    def define_model(self):
        ...
        if self.model_type == 'source':
            ...
            num_inputs_1 = 4
            num_inputs_2 = 4
            model = Model.NeuralNetworkModel_tanh_aniso(H, num_inputs_1, num_inputs_2, num_outputs, C_out)
...
def driver(argv):
    ...
    Nx1 = 256; Nx2 = 256;  dt = 1.0e-8; Nsteps = 20000000 # Re=1
    ...
    # Run it
    PyFlowCL_aniso.run( inputConfig )
